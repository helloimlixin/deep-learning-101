...
$$
\hat{x}_i_j = \frac{x_i_j - \mu_j}{\sigma_j},
$$
...
$$
\begin{aligned}
\mu_j &= \frac{1}{N} \sum_{i = 1}^N x_j_i \\
\sigma_j^2 &= \frac{1}{N} \sum_{i = 1}^N (x_i_j - \mu_j)^2
\end{aligned}
$$
...
>
> $\hat{\mathbf{x}}_i \gets \frac{\mathbf{x}_i - \boldsymbol{\mu}_\mathcal{B}}{\sqrt{\boldsymbol{\sigma}_\mathcal{B}^2 + \epsilon}}$ // normalize, $\epsilon$ is a small constant for numerical stability, say $1e-5$
>
